...
class onlinecourses (real_disc):
    def get_free_courses_from_page (self , url , headers):
        ...
        for h3 in h3s:
            ...
            c = course(course_name , coupon_link , "OnlineCourses")
    ...
    def get_category_url(self , category=None , value_13=None):
        ...
        if category in [1,3,4,5,6]:
            ...
            url = 'https://www.onlinecourses.ooo/coupon-tag/it-software/page/'
        elif category == 7:
            url = 'https://www.onlinecourses.ooo/coupon-tag/finance-accounting/page/'
        elif category == 8:
            url = 'https://www.onlinecourses.ooo/coupon-tag/health-fitness/page/'
        elif category == 9:
            url = 'https://www.onlinecourses.ooo/coupon-tag/office-productivity/page/'
        elif category == 10:
            url = 'https://www.onlinecourses.ooo/coupon-tag/personal-development/page/'
        elif category == 11:
            url = 'https://www.onlinecourses.ooo/coupon-tag/photography-video/page/'
        elif category == 12:
            url = 'https://www.onlinecourses.ooo/coupon-tag/teaching-academics/page/'
        elif category == 13:
