...
class coupon_eagle (real_disc):
    ...
    def get_category_url (self , category=None , value_13=None):
        ...
        if category in [1,3,9,6]:
            ...
            url =f"https://couponseagle.com/page/REPLACEME/?s=it+and+software&post_type=post"
        elif category == 4:
            url = f"https://couponseagle.com/page/REPLACEME/?s=DESIGN&post_type=post"
        elif category == 5:
            url = f"https://couponseagle.com/page/REPLACEME/?s=lifestyle&post_type=post"
        elif category == 7:
            url = f"https://couponseagle.com/page/REPLACEME/?s=Finance+%26+Accounting&post_type=post"
        elif category == 8:
            url = f"https://couponseagle.com/page/REPLACEME/?s=Health+%26+Fitness&post_type=post"
        elif category == 10:
            url = f"https://couponseagle.com/page/REPLACEME/?s=Personal+Development&post_type=post"
        elif category == 11:
            url = f"https://couponseagle.com/page/REPLACEME/?s=Teaching&post_type=post"
        elif category == 12:
            url = f"https://couponseagle.com/page/REPLACEME/?s=Photography+%26+Video&post_type=post"
        elif category == 13:
